...
function gotResult(error, results) {
    if (error) {
        ...
        if (results[0].label == "Pizza"){
            ...
            document.getElementById("pre1").innerHTML = "A slice of a standard cheese pizza (about 100–120 grams) contains around 250–300 calories.";
        } 
        else if (results[0].label == "Burger"){
            document.getElementById("rec1").innerHTML = "Burger";
            document.getElementById("pre1").innerHTML = "A cheeseburger typically contains 400–600 calories.";
        }
        else if (results[0].label == "Dosa"){
            document.getElementById("rec1").innerHTML = "Dosa";
            document.getElementById("pre1").innerHTML = "Plain dosa: ~120-160 calories.\nMasala dosa (with potato filling): ~250-350 calories depending on the filling";
        }
